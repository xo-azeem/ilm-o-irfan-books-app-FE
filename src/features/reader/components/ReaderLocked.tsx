  ...
  return (
    <Screen scrollable={false}>
      <View style={styles.root}>
        <View style={[styles.badge, { backgroundColor: colors.primaryFillSoft }]}>
        ...
        <Text size={fontSize.bodySmall} leading={1.7} tone="muted" align="center">
          {copy.message}
        </Text>

        {page && page > 1 ? (
          <Text size={fontSize.caption} leading={1.6} tone="soft" align="center">
