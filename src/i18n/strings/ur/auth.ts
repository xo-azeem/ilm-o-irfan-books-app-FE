...
export const auth: typeof en = {
  ...
  errors: {
    ...
    identityTaken:
      'یہ گوگل اکاؤنٹ پہلے ہی کسی دوسرے علم و عرفان اکاؤنٹ سے جڑا ہوا ہے۔ اسی سے سائن ان کریں یا کوئی دوسرا گوگل اکاؤنٹ چنیں۔',
    identityAlreadyLinked: 'یہ اکاؤنٹ پہلے ہی اس سے جڑا ہوا ہے۔',
    linkingDisabled: 'اس وقت اکاؤنٹ جوڑنا بند ہے۔ بعد میں کوشش کریں۔',
    lastIdentity:
      'یہی آپ کے اکاؤنٹ میں داخلے کا واحد راستہ ہے۔ پہلے پاس ورڈ مقرر کریں، پھر اسے ہٹا سکتے ہیں۔',
    unlinkEmailConflict:
      'جب تک اکاؤنٹ اسی پتے سے سائن ان کرتا ہے، یہ تعلق ہٹایا نہیں جا سکتا۔',
    verifyBeforeGoogle:
      'اس ای میل سے اکاؤنٹ تو موجود ہے مگر اس کی تصدیق نہیں ہوئی۔ پہلے پاس ورڈ سے سائن ان کر کے پتے کی تصدیق کریں، پھر سائن اِن طریقے میں جا کر گوگل جوڑیں۔',
  },
